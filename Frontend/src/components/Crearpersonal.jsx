...
function CrearPersonalForm() {  
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('http://localhost:3001/api/admin/crear-personal', formData);
      setSuccessMessage(response.data.message);
      setFormData({
        nombre: '', email: '', password: '', celular: '',
        tipo_documento: 'dni', numero_documento: '', rol: 'operador', fecha_nacimiento: ''
      });
  ...
  return (
    <div className="register-form-container" style={{ maxWidth: '600px', margin: '2rem auto' }}>
      ...
      <form onSubmit={handleSubmit} className="register-form" noValidate>
        ...
        <div className="form-group">
          <input type="text" name="numero_documento" placeholder="Documento" value={formData.numero_documento} onChange={handleChange} required />
        ...
        <div className="form-group">
          <input type="date" name="fecha_nacimiento" placeholder="Fecha nacimiento" value={formData.fecha_nacimiento} onChange={handleChange} required max={today} />
        ...
        <div className="form-group">
          <label style={{ textAlign: 'left', marginBottom: '5px', fontSize: '0.9rem' }}>
          </label>
        ...
        <button type="submit" className="submit-button"> Crear Personal </button>
        ...
        {successMessage && (
          <div className="form-group full-width" style={{ textAlign: 'center', color: 'green' }}>
            {successMessage}
          </div>
        )}
      </form>
